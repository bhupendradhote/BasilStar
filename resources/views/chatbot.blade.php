...
.select2-container--default .select2-selection--single .select2-selection__rendered {
        ...
        .select2-results__option
 {
    ...
    const apiUrl = `https://financialmodelingprep.com/api/v3/historical-chart/1day/${symbol}?from=${fromStr}&to=${toDate}&apikey=T8HogSezq0WNy97WinOjjLMEOuiKjnu5`;
    ...
    const apiUrl = `https://financialmodelingprep.com/api/v3/quote/${symbol}?apikey=T8HogSezq0WNy97WinOjjLMEOuiKjnu5`;
    const response = await fetch(apiUrl);
    const data = await response.json();
    ...
    return parseFloat(data[0].price);
        ...
        function generateTradeAnalysisReport(symbol) {
            ...
            // Construct the main recommendation string based on tradeType
            ...
            // Build the final formatted recommendation string
